...
TOOLS = ['Docker', 'npm', 'Homebrew', 'Yarn', 'Kubernetes', 'Ansible' , 'Gradle', 'Make', 'Pip', 'Vite' , 'Terraform']
...
COUNTRY = ['United Kingdom of Great Britain and Northern Ireland',
       'United States of America', 'Other', 'Italy', 'Canada',
...
#        'TypeScript', 'Python', 'Bash/Shell (all shells)', 'Java', 'C#', 'PHP', 'Go', 'C++',
#        'PowerShell']
# PLATFORM = ['Amazon Web Services (AWS)', 'Microsoft Azure', 'Google Cloud', 'Firebase', 'Heroku', 'Digital Ocean']
# TOOLS = ['Docker', 'npm', 'Homebrew', 'Yarn', 'Kubernetes']
# TYPES = ['Developer, full-stack', 'Developer, back-end', 'Developer, front-end',
#        'DevOps specialist', 'Cloud infrastructure engineer',
#        'Developer, desktop or enterprise applications', 'Developer, mobile',
#        'Database administrator', 'Engineering manager', 'System administrator',
#        'Data engineer', 'Project manager', 'Developer, QA or test',
#        'Developer, embedded applications or devices', 'Designer',
#        'Data scientist or machine learning specialist',
...
#        'TypeScript', 'Python', 'Bash/Shell (all shells)', 'Java', 'C#', 'PHP', 'Go', 'C++',
#        'PowerShell', 'Amazon Web Services (AWS)', 'Microsoft Azure',
#        'Google Cloud', 'Firebase', 'Heroku', 'Digital Ocean', 'Docker', 'npm',
